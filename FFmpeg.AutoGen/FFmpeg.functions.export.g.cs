...
namespace FFmpeg.AutoGen
{
    public unsafe static partial class ffmpeg
    {
        ...
        [DllImport("avcodec.58", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @name);
        ...
        [DllImport("avdevice.58", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @device_name, AVDictionary* @device_options, AVDeviceInfoList** @device_list);
        ...
        [Obsolete("")]
        [DllImport("avfilter.7", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @arg, byte* @res, int @res_len, int @flags);
        ...
        [DllImport("avformat.58", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @url_dst);
        ...
        /// <returns>b+c</returns>
        [DllImport("avutil.56", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    ...
    string @fmt, byte* @vl);
        ...
        [DllImport("postproc.55", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    ...
    string @name, int @quality);
        ...
        [DllImport("swresample.3", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [Obsolete("")]
        [DllImport("swscale.5", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
